...
import { AppstoreOutlined, UserOutlined, DollarOutlined, LogoutOutlined } from '@ant-design/icons'
// CSS
...
const Navbar = () => {
    ...
    return (
        <Menu selectedKeys={[currentPage]} mode="horizontal" className={navbarStyles.navbarTop}>
            ...
            <Menu.Item key="/users" icon={<UserOutlined />}><Link href="/users">Users</Link></Menu.Item>
            <Menu.Item key="/revenue" icon={<DollarOutlined />}><Link href="/revenue">Revenue</Link></Menu.Item>
